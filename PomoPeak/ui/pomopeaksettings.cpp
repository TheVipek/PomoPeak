...
#include <QMimeData>
#include <QFileInfo>
pomopeaksettings::pomopeaksettings(std::shared_ptr<Settings> _settings, std::shared_ptr<SqliteHandler> _handler, std::shared_ptr<GPTHelper> _gptHelper, QWidget *parent)
    : QWidget(parent)
